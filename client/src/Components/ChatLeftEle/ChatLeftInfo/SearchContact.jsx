...
import { syncContacts } from '../../service/actions/syncFetchContacts'
...
function SearchContact() {
  ...
  const createContact = () => {
      ...
      dispatch(syncContacts(contactData))
  };
        ...
        <div className='get-contacts'>
          {gotUser ? (
            <div className='search-user' >
              <p>{gotUser.userId}</p>
              <button onClick={createContact} className='message-user'>Message</button>
            </div>
          ) : (
